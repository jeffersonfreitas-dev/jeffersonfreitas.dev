      ...
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-7 col-12">
          <div class="about-content animate-slide-right">
            ...
            <div class="greeting-badge mb-4 animate-pop">
              <span class="badge">
                <font-awesome-icon :icon="['fa', 'hand-peace']" class="me-2" />
                {{ $t('hello_im') || 'Olá, eu sou' }}
              </span>
            </div>

            <!-- Título principal -->
            <h1 class="display-2 fw-bold mb-3 title-gradient">
              {{ $t('about_me') }}
            </h1>
            ...
            <div class="quick-stats fade-in" style="animation-delay: 0.9s">
              ...
              <div class="stat-item">
                ...
                <span class="stat-label">{{ $t('projects_completed') || 'Projetos completos' }}</span>
              </div>
              <div class="stat-item">
                <span class="stat-value">8</span>
                <span class="stat-label">{{ $t('certifications') || 'Certificações' }}</span>
              </div>
            </div>
          </div>
        </div>

        <!-- Coluna direita - Cards e ações -->
        <div class="col-lg-5 col-12">
          <div class="right-column animate-slide-left">
            <!-- Card de perfil com animação Lottie -->
            <div class="profile-card">
              ...
              <div class="profile-card-content">
                ...
                <div class="actions-grid">
                  <!-- Botão CV com dropdown animado -->
                  <div class="action-item">
                    <div class="btn-group w-100">
                      <button
                        type="button"
                        class="btn btn-gradient w-100 dropdown-toggle"
...
export default {
  data() {
    return {
      ...
      roles: ['Desenvolvedor Full Stack', 'Backend Specialist', 'Cloud Architect', 'Tech Lead'],
      favoriteTechs: [
