      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-12">
          <div class="project-list">
            <h3 class="mb-4 fw-bold">{{ $t('project_list') || 'Lista de Projetos' }}</h3>
            <div class="list-group">
              ...
              >
                <div class="d-flex align-items-center gap-3">
                  ...
                  <div>
                    <h6 class="mb-1 fw-bold">{{ projeto.name }}</h6>
                    <small class="opacity-75">{{ projeto.stacks.slice(0, 3).join(' • ') }}</small>
                  </div>
                </div>
              </button>
            </div>
        ...
        <!-- Carrossel do projeto selecionado (lado direito) -->
          ...
          <div class="project-carousel-card animate-slide-in">
            ...
            <div class="project-info">
              ...
              <div class="stacks-container mb-4">
                <h5 class="fw-bold mb-3">{{ $t('tech_used') || 'Tecnologias utilizadas' }}</h5>
        ...
        <div class="modal-content bg-dark text-white">
          ...
          <div class="modal-footer border-secondary">
            ...
            <a href="#projetos" class="btn btn-light" data-bs-dismiss="modal">
              {{ $t('back_to_projects') || 'Voltar para projetos' }}
            </a>
          </div>
        </div>
      </div>
