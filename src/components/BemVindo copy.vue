<template>
  <div class="hero-container text-white">
    ...
    <div class="container position-relative">
        ...
        <div class="col-lg-7 col-12">
          ...
          >
            <span class="greeting-badge">
              ...
              {{ $t('hello_world') || 'Olá, mundo!' }}
            </span>
          </div>

          <!-- Nome com efeito de gradiente -->
          <div 
            class="animate-slide-left"
            :style="{ animationDelay: '0.4s' }"
          >
            <h1 class="hero-title">
              <span class="static-text">{{ $t('i_am') || 'Eu sou' }}</span>
              <span class="name-gradient">Jefferson Freitas</span>
            </h1>
          </div>

          <!-- Título profissional com efeito de máquina de escrever -->
          <div 
          ...
          <!-- Descrição com highlights animados -->
          <div 
          ...
          >
            <p class="hero-description">
              {{ $t('quick_description') }}
              <span class="highlight-text">{{ $t('specialized_in') || 'Especializado em' }}</span>
          ...
          >
            <div class="d-flex align-items-center flex-wrap gap-3">
              ...
              <div class="social-links">
                ...
                <a href="#" class="social-link medium" target="_blank" rel="noopener noreferrer">
                  <font-awesome-icon :icon="['fab', 'medium']" class="fa-lg" />
            ...
            <div class="availability-badge mt-4">
              ...
              <span class="status-text">{{ $t('available_for_work') || 'Disponível para novos projetos' }}</span>
            </div>
          </div>
        </div>

        <!-- Coluna direita com Lottie e elementos visuais -->
          ...
          >
            ...
            <div class="experience-badge">
              <div class="badge-content">
                ...
                <span class="label">{{ $t('years_experience') || 'anos' }}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <span class="scroll-text">{{ $t('scroll_down') || 'Role para ver mais' }}</span>
...
export default {
  data() {
    return {
      ...
      currentTitleIndex: 0,
      isTyping: true,
      techStack: ['Java', 'Spring', 'Cloud', 'AWS', 'Angular'],
      typingTimeout: null,
      titleInterval: null
    }
  },
  ...
  methods: {
    ...
    loadRandomLottie() {
      const urls = [
        ...
        'https://assets9.lottiefiles.com/packages/lf20_vyjzqevs.json'
      ]
